  ...
  <template v-if="Ready">
    <div class="section-title">
      ...
      <a
        ...
        @click="this.filterShow = !this.filterShow"
      >
          ...
          <template #header>
            ...
            >
              ...
              >
                ...
                <a-select-option :value="this.words.length"
                  >全部</a-select-option
                >
              </a-select>
              ...
              >
                <template
                  v-for="index in Math.ceil(
                    this.words.length / this.selectPageSize
                  )"
                  :key="index"
                >
              ...
              <span style="margin-left: 8px">
                ...
                >
                  關鍵字：
                  <template
                    v-if="this.$keyword != '' && this.$filters.length > 0"
                  >
                    <template
                      v-if="
                        this.$filters.length === 1 &&
                        this.$filters.includes('cate_name')
                      "
                    >
                      `
          ...
          <template #renderItem="{ item, index }">
            <a-list-item>
              ...
              <a-card>
                    ...
                    <template v-else>
                      <template
                        v-if="
                          this.$keyword != '' &&
                          this.$filters.includes('cate_name') &&
                          item.cate_name.includes(this.$keyword)
                        "
                      >
                ...
                <template
                  v-if="
                    this.$WordsGroupsDetailsView.updateNow === true ||
                    checkboxShow === true
                  "
                >
                  <a-checkbox
                ...
                <template
                  v-if="
                    this.$keyword != '' &&
                    this.$filters.includes('ws_name') &&
                    item.ws_name.includes(this.$keyword)
                  "
                >
                  <router-link
                  ...
                  >
                    ...
                    >
                      <span
                        :class="{
                          'keyword-text': this.$keyword.includes(char)
                        }"
                        >{{ char }}</span
                      >
                    </template>
                ...
                <template v-if="isPronunciation">
                  ...
                  <template v-else>
                    <template
                      v-if="
                        this.$keyword != '' &&
                        this.$filters.includes('ws_pronunciation') &&
                        item.ws_pronunciation.includes(this.$keyword)
                      "
                    >
                      <template
                ...
                <template v-if="isDefinition">
                  ...
                  <template v-else>
                    <template
                      v-if="
                        this.$keyword != '' &&
                        this.$filters.includes('ws_definition') &&
                        item.ws_definition.includes(this.$keyword)
                      "
                    >
                      <template
